...
public class MiscellaneousAdapter extends RecyclerView.Adapter<NumberAdapter.MyViewHolder> {
    private final RecyclerViewInterface recyclerViewInterface;
    Context context;
    ArrayList<PatternModel> patternModels;

    public MiscellaneousAdapter(Context context, ArrayList<PatternModel> patternModels,RecyclerViewInterface recyclerViewInterface){
