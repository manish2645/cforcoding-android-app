...
import com.bytecode.cforcoding.R;

import java.util.ArrayList;

public class AlphabetAdapter extends RecyclerView.Adapter<NumberAdapter.MyViewHolder> {
    private final RecyclerViewInterface recyclerViewInterface;
    Context context;
    ArrayList<PatternModel> patternModels;

    public AlphabetAdapter(Context context, ArrayList<PatternModel> patternModels,RecyclerViewInterface recyclerViewInterface){
